...
import 'package:news_flutter/videoPlayer/utils.dart';
...
class _MaterialControlsState extends State<MaterialControls> {
    ...
    return MouseRegion(
      ...
      child: GestureDetector(
        ...
        child: AbsorbPointer(
          ...
          child: Column(
            children: <Widget>[
              _latestValue != null && !_latestValue!.isPlaying || _latestValue!.isBuffering
                  ? const Expanded(
                      child: const Center(
  ...
  Widget _buildPosition(Color? iconColor) {
    ...
    final duration = _latestValue != null ? _latestValue!.duration : Duration.zero;
  ...
  void _playPause() {
    bool isFinished;
    if (_latestValue!.duration != Duration(seconds: 0)) {
      ...
      child: Padding(
        ...
        child: MaterialVideoProgressBar(
          ...
          colors: chewieController!.materialProgressColors ??
              ChewieProgressColors(playedColor: Theme.of(context).colorScheme.secondary, handleColor: Theme.of(context).colorScheme.secondary, bufferedColor: Theme.of(context).colorScheme.background, backgroundColor: Theme.of(context).disabledColor),
        ),
      ),
    );
  }
