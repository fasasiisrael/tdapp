class CategoryModel {
  ...
  String? description;
  String? filter;
  String? image; // Image property already present
  String? name;
  int? parent;
  String? slug;
  String? taxonomy;
  ...
  factory CategoryModel.fromJson(Map<String, dynamic> json) {
    return CategoryModel(
      ...
      filter: json['filter'],
      image: json['https://i.ibb.co/7GmNG4F/tdpel.png'], // Image property already present
      name: json['name'],
      parent: json['parent'],
      slug: json['slug'],
  ...
  Map<String, dynamic> toJson() {
    ...
    data['image'] = this.image; // Image property already present
    data['name'] = this.name;
